...
const u16 gFrontierBannedSpecies[] =
{
    ...
    SPECIES_DIALGA, SPECIES_PALKIA, SPECIES_HEATRAN, SPECIES_REGIGIGAS, SPECIES_GIRATINA, 
    SPECIES_CRESSELIA, SPECIES_DARKRAI, SPECIES_ARCEUS, SPECIES_COBALION, SPECIES_TERRAKION, 
    SPECIES_VIRIZION, SPECIES_TORNADUS, SPECIES_THUNDURUS, SPECIES_RESHIRAM, SPECIES_ZEKROM, 
    SPECIES_LANDORUS, SPECIES_KYUREM, SPECIES_XERNEAS, SPECIES_YVELTAL, SPECIES_ZYGARDE, 
    SPECIES_SOLGALEO, SPECIES_LUNALA, SPECIES_NECROZMA, SPECIES_ZACIAN, SPECIES_ZAMAZENTA,
    SPECIES_ETERNATUS, 0xFFFF
};
