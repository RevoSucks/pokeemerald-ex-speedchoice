...
const struct WildPokemonHeader gWildMonHeaders[] =
{
    ...
    {
        .mapGroup = MAP_GROUP(ALTERING_CAVE_SUB_CAVE1),
    ...
    {
        .mapGroup = MAP_GROUP(ALTERING_CAVE_SUB_CAVE2),
    ...
    {
        .mapGroup = MAP_GROUP(ALTERING_CAVE_SUB_CAVE3),
    ...
    {
        .mapGroup = MAP_GROUP(ALTERING_CAVE_SUB_CAVE4),
    ...
    {
        .mapGroup = MAP_GROUP(ALTERING_CAVE_SUB_CAVE5),
    ...
    {
        .mapGroup = MAP_GROUP(ALTERING_CAVE_SUB_CAVE6),
    ...
    {
        .mapGroup = MAP_GROUP(ALTERING_CAVE_SUB_CAVE7),
    ...
    {
        .mapGroup = MAP_GROUP(ALTERING_CAVE_SUB_CAVE8),
