...
#define FLAG_SYS_NO_ENCOUNTER    0x21 // Unused Flag
#define FLAG_SYS_NO_TRAINER_SEE  0x22 // Unused Flag
#define FLAG_SYS_NO_BAG_USE      0x23 // Unused Flag
#define FLAG_SYS_NO_CATCHING     0x24 // Unused Flag
