...
#define B_CRASH_IF_TARGET_IMMUNE    GEN_8 // In Gen4+, The user of Jump Kick or Hi Jump Kick will "keep going and crash" if it attacks a target that is immune to the move.
...
#define B_X_ITEMS_BUFF              GEN_8 // In Gen7+, the X Items raise a stat by 2 stages instead of 1.
...
// DEPRECATED (use global debug enable instead.)
